...
for test_img in testing_imgs:
    ...
    predicted_boxes = []
    predicted_scores = []
    FLAG_DRAW_WITH_SLICE_IMGS = False
    ...
    # Draw Ground Truth Samples
    FLAG_DRAW_GROUND_TRUTH = False
    if FLAG_DRAW_GROUND_TRUTH:
        Annotations_Path = './Separate_Data/Test/Annotations/'
    ...
    # Performance
    FLAG_DRAW_WITH_PERFORMANCE = False
    if FLAG_DRAW_WITH_PERFORMANCE:
        detected_boxes_gt = []
        iou_for_boxed = []
